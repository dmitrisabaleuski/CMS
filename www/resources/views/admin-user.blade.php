...
@section('content')
    <div class="add-user col-xl-12 col-md-12 col-sm-12 col-xs-12">
        <p><a id="addUser" href="auth/register"><img src="img/plus-button.png" alt="add"></a></p>
    </div>
            ...
            @foreach($user as $users)
                <li>
                    <ul class="single-user">
                        ...
                        <li>
                            <ul>
                                <li><a class="btn btn-default edpost" role="buttom" href="{{route('userEdit',['id'=>$users->id])}}">Редактировать</a></li>
                                <li>
